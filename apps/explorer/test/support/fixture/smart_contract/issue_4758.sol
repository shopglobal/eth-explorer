...
/*
 * Interface for requests to the multi-rate oracle (for EUR/X and ERC20)
...
interface MultiOracleRequestI {
    ...
    /**
     * @dev Timestamp of when the last update for the X rate occurred
     */
    function lastUpdate() external view returns (uint256);

    /**
     * @dev Number of EUR per X (rounded down!)
     */
    function ETH_EUR() external view returns (uint256); // solhint-disable func-name-mixedcase

    /**
     * @dev Number of EUR cent per X (rounded down!)
     */
    ...
    /**
     * @dev Emitted on rate update - using address(0) as tokenAddress for X updates
     */
...
library Address {
     ...
     * Requirements:
     *
     * - the calling contract must have an X balance of at least `value`.
...
contract CS3_1OnChainShop {
    ...
    // Buy assets. The number of assets is determined from the amount of X sent.
